                    ...
                    for i in range(len(sentence_words)-len(extracted_tokens)):
                        ...
                        for entity in candidates:
                            ...
                            if relation in relations:
                                relations[relation].append((term, potential_entity))
                            else:
                                relations[relation] = [(term, potential_entity)]
                            # term = " ".join(extracted_tokens)
...
if __name__ == "__main__":
    ...
    # relator = RelationExtractor(snlp_corpus, "../results/extracted_terms/kpminer.csv")
    # candidate_relations = relator.extract()
    # with open("../results/extracted_relations/sample_41.json", "w") as json_file:
